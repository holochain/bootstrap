...
export const AgentInfoSignedRawSafe: D.Decoder<
  MP.MessagePackData,
  AgentInfoSignedRaw
> = {
...
export const AgentInfoSignedSafe: D.Decoder<
  MP.MessagePackData,
  AgentInfoSigned
> = {
  decode: (a: MP.MessagePackData) => {
          ...
          pipe(
            ...
            E.fold(
              ...
              (agentInfoValue) => {
                ...
                if (
                  !_.isEqual(
                    agentInfoSignedRawSafeValue.agent,
                    agentInfoValue.agent,
                  )
                ) {
                  return D.failure(
                    a,
                    `Outer signed agent ${agentInfoSignedRawSafeValue.agent} does not match signed inner agent ${agentInfoValue.agent}.`,
                  )
                }

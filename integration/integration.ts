...
describe('integration tests', () => {
  for (const query of ['', '?net=tx2', '?net=tx5']) {
    let url = 'http://127.0.0.1:8787' + query

    it('should GET correctly (' + query + ')', async function () {
      this.timeout(0)
    ...
    it('should handle POST errors (' + query + ')', async function () {
    ...
    it('should POST/proxy_list correctly (' + query + ')', async function () {
    ...
    it('should trigger_scheduled / metrics correctly (' + query + ')', async function () {
      this.timeout(0)
    ...
    it('should POST correctly (' + query + ')', async function () {
      // needs an extended timeout to post everything
      this.timeout(0)

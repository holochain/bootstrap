...
export const alice = {
  ...
  secretKey: Uint8Array.from([
    185, 17, 98, 189, 195, 23, 240, 235, 171, 51, 178, 214, 33, 25, 217, 20,
    250, 197, 248, 164, 162, 36, 218, 17, 6, 152, 241, 29, 72, 36, 246, 155, 95,
    62, 138, 155, 147, 98, 254, 130, 27, 90, 189, 22, 214, 159, 53, 71, 110, 8,
    222, 90, 16, 252, 179, 208, 115, 252, 10, 63, 244, 211, 125, 115,
  ]),
}

export const bob = {
  publicKey: Uint8Array.from([
    208, 28, 22, 215, 187, 154, 60, 168, 229, 6, 79, 163, 128, 143, 17, 156,
    124, 230, 192, 4, 137, 124, 84, 121, 212, 49, 14, 156, 25, 120, 4, 129,
  ]),
  secretKey: Uint8Array.from([
    145, 37, 159, 254, 196, 64, 171, 49, 149, 7, 17, 253, 171, 58, 253, 214, 8,
    76, 23, 4, 162, 194, 57, 130, 150, 208, 107, 148, 95, 253, 168, 61, 208, 28,
    22, 215, 187, 154, 60, 168, 229, 6, 79, 163, 128, 143, 17, 156, 124, 230,
    192, 4, 137, 124, 84, 121, 212, 49, 14, 156, 25, 120, 4, 129,
  ]),
}
